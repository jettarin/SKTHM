angular.module('myApp').config([ '$routeProvider', function($routeProvider) {
	$routeProvider.when("/edit-application", {templateUrl: _.toHttpGetUrl("content/application/edit-application/edit-application.html"), controller: EditApplicationCtrl });
	$routeProvider.when('/edit-application-detail/:id', {templateUrl: _.toHttpGetUrl('content/application/edit-application-detail.html'), controller: EditApplicationDetailCtrl});
} ]);

function EditApplicationCtrl($rootScope, $scope, $http, $compile, $filter, $timeout, $routeParams, $location, $log) {
	$log.info('Enter EditApplicationCtrl');
	...
	$scope.policyTypeList = [{"id":"1", "name":"พ.ร.บ."}
...
$scope.projectList = 
	...
	$scope.search = function(){		
		...
		$rootScope.paging.totalItems = $scope.editAppList.length;
		$rootScope.paging.showing = _.getShowing($rootScope.paging.pageNumber, $rootScope.paging.limit, $scope.editAppList.length);
		
		$scope.data = [{"no":"1","branch":"สำนักงานใหญ่","licenseNo":"กว 9090 กทม","appNo":"OTISCKPI002490001","chassisNo":"33JHSDFKI239","coverDate":"01/01/2557-01/01/2558","assured":"นายวิโรจน์ ชูวงศ์","contactName":"นายวิเชียร เลาหบุตร","premium":"1,074.28","status":"Complete","appointmentDate":"01/01/2557","surveyor":"นายสำเภา นิจจันทร์","status":"นัดหมายได้","remark":""}
		,{"no":"2","branch":"สำนักงานใหญ่","licenseNo":"จน 5755 กทม","appNo":"OTISCKPI002490002","chassisNo":"SDDFKJO399DSF","coverDate":"01/01/2557-01/01/2558","assured":"นายพงษ์เทพ ธรรมโสพน","contactName":"นายวิเชียร เลาหบุตร","premium":"757.21","status":"Complete","appointmentDate":"01/01/2557","surveyor":"นายสำเภา นิจจันทร์","status":"นัดหมายได้","remark":""}
		,{"no":"3","branch":"สำนักงานใหญ่","licenseNo":"รว 9900 กทม","appNo":"OBASNKPI002490001","chassisNo":"032SDFJLLJSDF","coverDate":"01/01/2557-01/01/2558","assured":"นายวรวัฒน์ สอนจันทร์","contactName":"นายวิเชียร เลาหบุตร","premium":"757.21","status":"Complete","appointmentDate":"","surveyor":"นายสำเภา นิจจันทร์","status":"นัดหมายไม่ได้","remark":"ติดต่อไม่ได้"}
		,{"no":"4","branch":"สำนักงานเขต1","licenseNo":"3กก 1 กทม","appNo":"OBASNKPI002490002","chassisNo":"SDFJE93JSLDKF","coverDate":"01/01/2557-01/01/2558","assured":"นายวิชัย ศรีบุรินทร์","contactName":"นายวิเชียร เลาหบุตร","premium":"757.21","status":"Complete","appointmentDate":"","surveyor":"นายสำเภา นิจจันทร์","status":"นัดหมายไม่ได้","remark":"โทรไม่ติด"}
		,{"no":"5","branch":"สำนักงานเขต1","licenseNo":"3กย 99 กทม","appNo":"OBASNKPI002490003","chassisNo":"9432LDKDSJFFD","coverDate":"01/01/2557-01/01/2558","assured":"นายสงคราม อาจสมบาล","contactName":"นายวิเชียร เลาหบุตร","premium":"757.21","status":"Complete","appointmentDate":"01/01/2557","surveyor":"นายสำเภา นิจจันทร์","status":"นัดหมายได้","remark":""}
		,{"no":"6","branch":"สำนักงานเขต2","licenseNo":"1กด 191 กทม","appNo":"OAKTCKPI002490001","chassisNo":"SDFJKHDSF93DF","coverDate":"01/01/2557-01/01/2558","assured":"นางจุรีรัตน์ ศรีจันทร์","contactName":"นายวิเชียร เลาหบุตร","premium":"18,900.00","status":"Survey Awaiting","appointmentDate":"","surveyor":"นายสำเภา นิจจันทร์","status":"ยังไม่ได้นัดหมาย","remark":""}
		/*,{"no":"7","branch":"สำนักงานเขต 3","licenseNo":"3กด 3 กทม","appNo":"OAKTCKPI002490003","chassisNo":"DSFLSKDF93RFJS","coverDate":"01/01/2557-01/01/2558","assured":"น.ส.อรุณรัตน์ ปวรรัตน์","contactName":"นายวิเชียร เลาหบุตร","premium":"8,080.00","status":"New","appointmentDate":"01/01/2557","surveyor":"นายสำเภา นิจจันทร์","status":"นัดหมายได้","remark":""}
		,{"no":"8","branch":"สำนักงานเขต 4","licenseNo":"3กล 45 กทม","appNo":"OAKTCKPI002490004","chassisNo":"SDF320IDSFL3","coverDate":"01/01/2557-01/01/2558","assured":"นายพงศกร แก้วเก้า","contactName":"นายวิเชียร เลาหบุตร","premium":"3,000.00","status":"Payment Awaiting","appointmentDate":"01/01/2557","surveyor":"นายสำเภา นิจจันทร์","status":"นัดหมายได้","remark":""}
		,{"no":"9","branch":"สำนักงานเขต 4","licenseNo":"3กบ 54 กทม","appNo":"OAKTCKPI002490005","chassisNo":"SDFLJ2SDF33DF","coverDate":"01/01/2557-01/01/2558","assured":"นายศักดิ์ชัย อำนายศิลป์","contactName":"นายวิเชียร เลาหบุตร","premium":"12,000.00","status":"Payment Awaiting","appointmentDate":"01/01/2557","surveyor":"นายสำเภา นิจจันทร์","status":"นัดหมายได้","remark":""}
		,{"no":"10","branch":"สำนักงานเขต 4","licenseNo":"2กด 8 กทม","appNo":"OAKTCKPI002490006","chassisNo":"2JLDFK329DFJ","coverDate":"01/01/2557-01/01/2558","assured":"นายกวี อำนวยศิลป์","contactName":"นายวิเชียร เลาหบุตร","premium":"12,000.00","status":"Complete","appointmentDate":"01/01/2557","surveyor":"นายสำเภา นิจจันทร์","status":"นัดหมายได้","remark":""}*/];
	...
	$scope.gotoEdit = function(id) {
		$location.path('edit-app-detail/'+id);
	};
};

function EditApplicationDetailCtrl($rootScope, $scope, $http, $compile, $timeout, $filter, $location,$routeParams) {
	...
	/*	$scope.canList = $scope.app.user.userFunction.indexOf('$errormessage.list') > -1;
		...
		$scope.policyTypeList = [
		                  		 {"policyCode":"0001", "policyName":"พ.ร.บ."}
