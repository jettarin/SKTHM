angular.module('myApp').config([ '$routeProvider', function($routeProvider) {
	 $routeProvider.when("/all-policy-list", {templateUrl: _.toHttpGetUrl("content/policy/all-policy-list/all-policy-list.html"), controller: AllPolicyListCtrl});
	 $routeProvider.when('/all-policy-list/:id', {templateUrl: _.toHttpGetUrl('content/policy/all-policy-list/all-policy-detail.html'), controller: AllPolicyListDetailCtrl});
} ]);

function AllPolicyListCtrl($rootScope, $scope, $http, $compile, $timeout, $filter, $location) {
	...
	$scope.statusList = [{"id":"01","name":"รอพิมพ์กรมธรรม์"},
                     {"id":"02","name":"รอจัดส่งกรมธรรม์"},
                     {"id":"03","name":"จัดส่งแล้ว"},
                     {"id":"04","name":"กรมธรรม์ตีกลับ"},
                     {"id":"05","name":"ลูกค้าได้รับกรมธรรม์แล้ว"},
                     {"id":"06","name":"ยกเลิกกรมธรรม์"},
                     {"id":"07","name":"แก้ไขกรมธรรม์"}
	...
	$scope.search = function(){
		...
		$scope.allApplicationList = 
			[{"no":"1","appNo":"AP0157/00001","policyNo":"01AHI00124","project":"ASN KTC","productId":"001","product":"ภาคสมัครใจชั้น 1","newRenew":"New","assured":"นายวิโรจน์ ชูวงศ์","effectiveDate":"01/10/2557","expireDate":"01/06/2558","requestDate":"01/05/2557","premium":"18,900.00","status":"รอการชำระเงิน"}
			,{"no":"2","appNo":"AP0157/00002","policyNo":"01AHI00125","project":"ASN KTC","productId":"002","product":"ภาคสมัครใจชั้น 2","newRenew":"New","assured":"นายพงษ์เทพ ธรรมโสพล","effectiveDate":"19/10/2557","expireDate":"19/10/2557","requestDate":"31/08/2557","premium":"7,900.00","status":"ชำระไม่ผ่าน"}
			,{"no":"3","appNo":"AP0157/00003","policyNo":"01AHI00126","project":"ASN KTC","productId":"003","product":"ภาคสมัครใจชั้น 3","newRenew":"New","assured":"นายวรวัฒน์ สอนจันทร์","effectiveDate":"11/10/2557","expireDate":"11/10/2557","requestDate":"31/08/2557","premium":"3,400.00","status":"รอยืนยันจากธนาคาร"}
			,{"no":"4","appNo":"AP0157/00004","policyNo":"01AHI00127","project":"ASN KTC","productId":"004","product":"พรบ","newRenew":"New","assured":"นายวิชัย ศรีบุรินทร์","effectiveDate":"01/06/2557","expireDate":"01/06/2558","requestDate":"31/08/2557","premium":"600.00","status":"สร้างกรมธรรม์"}
			,{"no":"5","appNo":"AP0157/00005","policyNo":"01AHI00128","project":"ASN","productId":"001","product":"ภาคสมัครใจชั้น 1","newRenew":"New","assured":"นายสงคราม อาจสมบาล","effectiveDate":"01/06/2557","expireDate":"01/06/2558","requestDate":"31/08/2557","premium":"16,345.00","status":"รอตรวจสภาพรถ"}
			,{"no":"6","appNo":"AP0157/00006","policyNo":"01AHI00129","project":"ASN","productId":"002","product":"ภาคสมัครใจชั้น 3","newRenew":"Renew","assured":"นางจุรีรัตน์ ศรีจันทร์","effectiveDate":"01/06/2557","expireDate":"01/06/2558","requestDate":"31/08/2557","premium":"3,500.00","status":"สร้างกรมธรรม์"}
			,{"no":"7","appNo":"AP0157/00007","policyNo":"01AHI00130","project":"ASN","productId":"005","product":"ภาคสมัครใจชั้น 3+","newRenew":"Renew","assured":"นายวิเชียร เลาหบุตร","effectiveDate":"01/06/2557","expireDate":"01/06/2558","requestDate":"31/08/2557","premium":"4,000.00","status":"สร้างกรมธรรม์"}
			,{"no":"8","appNo":"AP0157/00008","policyNo":"01AHI00131","project":"ASN","productId":"004","product":"พรบ","newRenew":"New","assured":"นางจันทร์ฉาย สมส่วน","effectiveDate":"01/06/2557","expireDate":"01/06/2558","requestDate":"31/08/2557","premium":"700.00","status":"สร้างกรมธรรม์"}];
...
function AllPolicyListDetailCtrl($rootScope, $scope, $http, $compile, $timeout, $filter, $location,$routeParams ,$log) {
